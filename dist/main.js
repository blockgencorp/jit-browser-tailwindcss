...
__export(module_exports, {
  createTailwindcss: () => createTailwindcss,
  createTailwindcssPlugin: () => createTailwindcssPlugin,
  default: () => src_default,
  jitBrowserTailwindcss: () => jitBrowserTailwindcss
});
module.exports = __toCommonJS(module_exports);

// src/index.ts
var import_postcss8 = __toESM(require("postcss"), 1);
...
var import_postcss_selector_parser6 = __toESM(require("postcss-selector-parser"));

// node_modules/tailwindcss/src/util/parseObjectStyles.js
var import_postcss = __toESM(require("postcss"));
var import_postcss_nested = __toESM(require("postcss-nested"));
var import_postcss_js = __toESM(require("postcss-js"));
...
var import_postcss_selector_parser3 = __toESM(require("postcss-selector-parser"));
var import_unesc = __toESM(require("postcss-selector-parser/dist/util/unesc.js"));

// node_modules/tailwindcss/src/util/escapeClassName.js
var import_postcss_selector_parser2 = __toESM(require("postcss-selector-parser"));
...
var import_postcss_selector_parser4 = __toESM(require("postcss-selector-parser"));
  ...
  pseudoElementVariants: ({ addVariant }) => {
    ...
    addVariant("before", ({ container }) => {
      container.walkRules((rule) => {
        ...
        if (!foundContent) {
          rule.prepend(import_postcss3.default.decl({ prop: "content", value: "var(--tw-content)" }));
        }
      });
      return "&::before";
    });
...
function parseVariant(variant) {
  ...
  let fns = parseVariantFormatString(variant).map((str) => {
    ...
    return ({ wrap }) => wrap(import_postcss4.default.atRule({ name, params: params?.trim() ?? "" }));
  }).reverse();
  return (api) => {
    for (let fn of fns) {
      fn(api);
    ...
    for (let [name, options] of context.variantOptions.entries()) {
      ...
      result.push({
        ...
        selectors({ modifier, value: value2 } = {}) {
          ...
          let rule = import_postcss4.default.rule({ selector: `.${candidate}` });
          let container = import_postcss4.default.root({ nodes: [rule.clone()] });
...
function createContext(tailwindConfig, changedContent = [], root = import_postcss4.default.root()) {
  let context = {
    disposables: [],
...
var import_postcss_selector_parser5 = __toESM(require("postcss-selector-parser"));
...
function applyPrefix(matches, context) {
  ...
  for (let match of matches) {
    ...
    if (meta.options.respectPrefix) {
      let container = import_postcss5.default.root({ nodes: [match[1].clone()] });
...
var import_postcss_selector_parser7 = __toESM(require("postcss-selector-parser"));
      ...
      for (let [meta, node] of rules) {
        ...
        if (canRewriteSelector) {
          root2.walkRules((rule) => {
            ...
            let selector = (0, import_postcss_selector_parser7.default)().astSync(rule.selector);
            selector.each((sel) => movePseudos(sel));
...
var import_didyoumean = __toESM(require("didyoumean"));
...
var import_postcss_selector_parser8 = __toESM(require("postcss-selector-parser"));
var getNode = {
  id(node) {
...
var createTailwindcss = ({ tailwindConfig } = {}) => {
  ...
  return {
    ...
    async generateStylesFromContent(css, content) {
      ...
      const processor = (0, import_postcss8.default)([tailwindcssPlugin]);
